function shuffle_identified_percent_runs_xcpd_dtseries(SUB, SES, FD, TASK, TR, MAXMIN, permnum, infolder, infile,BASEDIR,intrp_noise,shuffle_option,percent_chunk_size)
...
MIN=35
S_KERNEL=2.55
DERIVATIVESDIR=/home/yaco0006/shared/projects/HighField_7T/data/processed/derivatives/FD-0.3mm/xcp_d/
intrp_noise=0
BASEDIR=/projects/standard/faird/shared/code/internal/analytics/TemplateShuffle/example_out/TM_permutations/
...
SURF_ONLY=2
shuffle_option=percent
percent_chunk_size=10
%intrp_noise=1;%
if intrp_noise == 1
    % Add required paths
