function TM_dscalar_compare_across_permutations_surf_only(BASEDIR, dscalarswithassignments1, percent_holdout, make_NetConfMaps)
...
if make_NetConfMaps == 1
    ...
    visualizedscalars(dscalarswithassignments1,fig_out,'calc_probability',1,surf_only,0);

    fig_out=[cifti_dir '/Mode_of_Shuffled_dscalars_Percent_holdout']
    visualizedscalars(dscalarswithassignments1,fig_out,'calc_mode',1,surf_only,0);
