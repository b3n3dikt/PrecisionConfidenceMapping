function [cmd] = plot_surface_and_subcorticals(dscalar, BASEDIR, lowerthresh, upperthresh, colorscheme)

%clear all
% STANDALONE PCM: Removed hardcoded addpath calls and hardcoded wb_command.
% All paths are now computed relative to this file's location using mfilename.
...
%%
% STANDALONE PCM: paths now computed relative to this file (see top of function)
