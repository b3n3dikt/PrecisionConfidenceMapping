function[output_cifti_name] = Zscore_dconn_surface_only_sigma_rat(input_cifti_name,output_cifti_name)
...
if exist('exclude_lower_triangle','var') == 1 % not debugged
    LL_mat_size = 20430; %hardcode - number of parcellations
    LR_mat_size = 20309;
    %SS_mat_size = 72817;
...
%newdconn=single(zeros(113556,113556)); %from Zscore_dconn.m
...
if exist('plot_distributions','var') == 1 % not debugged
    ...
    %mat_size = 113556; %hardcode - number of parcellations
    mat_size = 40739; %hardcode - number of parcellations
