...
templatesurfL="/projects/standard/faird/shared/code/internal/utilities/figure_maker/L.sphere.59k_fs_LR.surf.gii"
templatesurfR="/projects/standard/faird/shared/code/internal/utilities/figure_maker/R.sphere.59k_fs_LR.surf.gii"
...
if [ "${label}" = FALSE ]; then 
	...
	temp_scene=${temp_scene:-"/projects/standard/faird/shared/code/internal/utilities/figure_maker/MSC01_template_quad_scaled_v3_legend_fixed_MSI_170k.scene"}
	templatefile=${templatefile:-"170494_Greyordinates.dscalar.nii"}
	...
	old_templatefile=${old_templatefile:-"170494_Greyordinates.dscalar.nii"}
	...
	continuous_zero_default=${continuous_zero_default:-"false</DisplayZeroData>"} #scene file changes associated workbench 1.4.2
  #continuous_zero_default=${continuous_zero_default:-"FALSE<&lt;/DisplayZeroData"
	...
	#Reference Scene file:
	temp_scene=${temp_scene:-"/home/exacloud/lustre1/fnl_lab/code/internal/utilities/make_dscalar_pics/template_veryinflated_label_170k.scene"}
...
echo "WB_command is: ${wb_command}"
echo "temp_scene is: ${temp_scene}"
echo "temp_scene_sub is: ${temp_scene_sub}"

echo "left_surface_path: ${left_surface_path}"
echo "right_surface_path: ${right_surface_path}"

echo "continuous lower is: ${continuous_lower}"
echo "continuous upper is: ${continuous_upper}"
...
echo "Replacing instances of: ${templatesurfL} with ${left_surface_path}"
tm1=${templatesurfL}
tm2=${left_surface_path}
#sed -i "s!${templatefolder}_PATH!${subjectfoldername}!g" $outputfilename
sed -i "s,${tm1},${tm2},g" "$outputfilename"

echo "Replacing instances of: ${templatesurfR} with ${right_surface_path}"
tm3=${templatesurfR}
tm4=${right_surface_path}
#sed -i "s!${templatefolder}_PATH!${subjectfoldername}!g" $outputfilename
sed -i "s,${tm3},${tm4},g" "$outputfilename"
...
if [ "${label}" = FALSE ]; then #scaler
echo "Using dscalar options..."
...
if [ "${make_subcorticals}" = TRUE ]; then 
    ...
    echo "Label is set to FALSE in subcortical section."
		...
		temp_scene_sub=${temp_scene_sub:-"/home/exacloud/lustre1/fnl_lab/code/internal/utilities/make_dscalar_pics/MSC01_template_scene_subcort_scalar_MSI_170k.scene"}
		
    templatefile_sub=${templatefile:-"ABCD_10min_GRP1_singlenet_percentage_n2988_Aud_network_percentage.dscalar.nii"}
		templatefolder_sub=${templatefolder:-"/home/exacloud/lustre1/fnl_lab/code/internal/analyses/compare_matrices/ABCD_percentage_maps/"}
		old_templatefolder_sub=${old_templatefolder_sub:-"/projects/standard/faird/shared/code/internal/utilities/figure_maker/"}
		old_templatefile_sub=${old_templatefile_sub:-"170494_Greyordinates.dscalar.nii"}
		...
		#Scale values	
		continuous_lower_default=${continuous_lower_default:-"-55.555000"}
		continuous_upper_default=${continuous_upper_default:-"66.666000"}
		#continuous_lower_default=${-55.549999}
		#continuous_upper_default=${66.660004}
    ...
    continuous_zero_default=${continuous_zero_default:-"false</DisplayZeroData>"}
		...
		threshold_lower_default=${threshold_lower_default:-"55.555000"}
		threshold_upper_default=${threshold_upper_default:-"66.666000"}
		#threshold_lower_default=${0.444000}
    #threshold_upper_default=${1.111000}
    ...
    threshold_inout_default=${threshold_inout_default:-"THRESHOLD_TEST_SHOW_OUTSIDE"}
		...
		temp_scene_sub=${temp_scene_sub:-"/home/exacloud/lustre1/fnl_lab/code/internal/utilities/make_dscalar_pics/MSC01_template_scene_subcort_label_MSI_170k.scene"}
		...
		#Scale values	
		continuous_lower_default=${continuous_lower_default:-"-33.333000"}
		continuous_upper_default=${continuous_upper_default:-"44.444000"}
	...
	## FIX here for multiple file names present in template file. EF EDIT: START WITH OLD TEMPLATE SINCE IT WILL CAUSE ERRORS
	echo "Replacing instances of: ${old_templatefolder_sub} with ${subjectfoldername}"
	kathy19=${old_templatefolder_sub}
	kathy20=${subjectfoldername}
	sed -i "s,${kathy19},${kathy20},g" "$outputfilename_sub"

	echo "Replacing instances of: ${old_templatefile_sub} with ${subjectfilename}"
	kathy21=${old_templatefile_sub}
	kathy22=${subjectfilename}
