...
input_dscalar=${1}; shift #dscalar path
lower_thres=${1}; shift #lower limit for color bar
upper_thres=${1}; shift #upper limit for color bar
...
echo "lower limit is: " ${lower_thres}
echo "upper limit is: " ${upper_thres}
...
echo "gview ${filedir_name}/${fileroot_name_short}.png"