...
# Replace hardcoded MSCcodebase Conte69 directory with the bundled deps/Conte69_surfaces/ path.
# left_surface_path is already passed as an argument, so dirname gives us the right directory.
_old_conte69_dir="/projects/standard/faird/shared/code/external/utilities/MSCcodebase-master/Utilities/Conte69_atlas-v2.LR.32k_fs_LR.wb"
_new_conte69_dir="$(dirname "${left_surface_path}")"
sed -i "s,${_old_conte69_dir},${_new_conte69_dir},g" "$outputfilename"
...
if [ "${make_subcorticals}" = TRUE ]; then 
    ...
    threshold_inout_default=${threshold_inout_default:-"THRESHOLD_TEST_SHOW_OUTSIDE"}
		...
		old_templatefolder_sub=${old_templatefolder_sub:-"/home/exacloud/lustre1/fnl_lab/code/internal/analyses/compare_matrices/ABCD_percentage_maps/n1800_old/"}
		old_templatefile_sub=${old_templatefile_sub:-"ABCD_10min_GRP1_overlap_percentage_n1800_Aud_network_percentage.dscalar.nii"}
	...
	# Replace hardcoded MSCcodebase Conte69 directory in subcortical scene.
	sed -i "s,${_old_conte69_dir},${_new_conte69_dir},g" "$outputfilename_sub"
