...
% Patches the "power_surf" PaletteColorMapping metadata (fixed 1-18 user scale,
% matching the Power/ABCC 18-network color scheme) directly into a cifti file's
% own NIFTI-2 header extension XML, in place. clean_dscalars_by_size_standalone.m
% calls this on every recolored dscalar/dtseries it writes.
%
